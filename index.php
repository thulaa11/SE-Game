...
if (!isset($_SESSION['user_id'])) {
    // ensure user must authenticate before seeing game
...
<body>
    <!-- Dynamic loading screen (shown after login until game is ready) -->
